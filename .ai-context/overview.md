...
release is `0.1.0`; the top README uses Base's tests/platform/version badge
...
`uv.lock` pin the base-cli version from `.release/supported-dependencies.json`
for the normal project environment. Base's
